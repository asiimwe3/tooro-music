  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: "linear-gradient(180deg,#15102B 0%,#0B0918 100%)",
        ...
        <div style={{ padding: "28px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 46, height: 46, borderRadius: 14, background: "linear-gradient(135deg,#9B6DFF,#FF6BA8)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, boxShadow: "0 6px 20px rgba(155,109,255,0.4)" }}>🎵</div>
            <div>
              <div style={{ fontSize: 17, fontWeight: 900, color: "#F0F0FF" }}>Tooro Music</div>
